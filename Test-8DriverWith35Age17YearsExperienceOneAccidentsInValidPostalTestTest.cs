...
[TestFixture]
public class DriverWith35Age17YearsExperienceOneAccidentsInValidPostalTestTest {
  ...
  [Test]
  public void driverWith35Age17YearsExperienceOneAccidentsInValidPostalTest() {
    ...
    driver.FindElement(By.Id("lastName")).SendKeys("vinnu");
    driver.FindElement(By.Id("address")).Click();
    driver.FindElement(By.Id("address")).SendKeys("12 clen street");
    driver.FindElement(By.Id("city")).Click();
    driver.FindElement(By.Id("city")).SendKeys("toronto");
    driver.FindElement(By.Id("province")).Click();
    driver.FindElement(By.Id("postalCode")).Click();
    driver.FindElement(By.Id("postalCode")).SendKeys("N2L 4HH");
    ...
    {
      var element = driver.FindElement(By.CssSelector(".col-md-2"));
